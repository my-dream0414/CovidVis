const tags = (function () {
    ...
    function updateTagCloud(options) {
        ...
        $.each(bib.filteredEntries, function (id) {
            ...
            //console.log( bib.parsedEntries[id])
        ...
        appendTagDivs(options.field === 'VisualForms' ? 'other' : '', 'unclassified tags', tagDivs, containerDiv);
